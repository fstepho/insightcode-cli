...
├── context-builder.ts:758      # Rich context extraction for LLM analysis ⭐⭐⭐⭐
...
├── reporter-legacy.ts:437      # Legacy terminal output ⭐⭐
...
- **context-builder.ts:758** - Rich context for LLM analysis
