...
## 📊 Quick Status
<!-- GIT-HOOK:START -->
Last Analysis: 2025-07-13 02:30
...
├── dependency-analyzer.ts:1220  # Dependency graph - incomingCount metrics ⭐⭐⭐⭐⭐
├── types.ts:415                # TypeScript types - enhanced interfaces ⭐⭐
├── context-builder.ts:485     # Rich context extraction for LLM analysis ⭐⭐⭐⭐
...
- **dependency-analyzer.ts:1220** - Complex dependency analysis
- **context-builder.ts:485** - Rich context for LLM analysis
...
- 2025-07-13: Update changelog, README, and user guides for v0.6.1 release; enhance error handling and logging in dependency analyzer
